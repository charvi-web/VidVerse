...
//validobjectid checks if the string is a valid mongo id 
...
const getAllVideos = asyncHandler(
    async(req,res)=>{
        ...
        pipeline.push({
            //JOIN jaisi functioning krta h loookup
            $lookup:{
                from:"users",
                localField:"owner",
                foreignField:"_id",
            ...
            {// lookup array return karta hai
        // isko object format me convert karta hai
                $unwind : "$ownerDetails" //returns in a cleaner format
            }
    )
